...
def main():
    ...
    parser.add_argument('-hl','--lang', metavar='', required=False, type=str, default=None, help='Language of the search. Supported only for "google", "baidu", "yahoo" and "yandex" engines. Default "%(default)s".')
    parser.add_argument('-gl','--country', metavar='', required=False, type=str, default=None, help='Country of the search. Supported only for "google", "bing" and "yahoo" engines. Default "%(default)s".')
    parser.add_argument('-loc', '--location', metavar='', required=False, type=str, default=None, help='Location of the search. Supported only for "google", "bing", "duckduckgo" and "yandex" engines. Default "%(default)s".')
    parser.add_argument('-d','--domain', metavar='', required=False, type=str, default=None, help='Search engine domain to use. Supported only for "google", "yahoo" and "yandex" engines. Default "%(default)s".')
